...
public class TransitionTest extends StateBasedGame {
    ...
    public void initStatesList(GameContainer container) throws SlickException {
        addState((GameState)new ImageState(0, "testdata/wallpaper/paper1.png", 1));
        addState((GameState)new ImageState(1, "testdata/wallpaper/paper2.png", 2));
        addState((GameState)new ImageState(2, "testdata/bigimage.tga", 0));
    }
    ...
    public static void main(String[] argv) {
        try {
            AppGameContainer container = new AppGameContainer((Game)new TransitionTest());
