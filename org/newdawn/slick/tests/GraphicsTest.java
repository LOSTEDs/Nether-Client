...
public class GraphicsTest extends BasicGame {
    ...
    public void render(GameContainer container, Graphics g) throws SlickException {
        ...
        for (int x = 0; x < 360; x += 10)
            g.drawLine(700.0F, 100.0F, (int)(700.0D + Math.cos(Math.toRadians(x)) * 100.0D), (int)(100.0D + Math.sin(Math.toRadians(x)) * 100.0D)); 
    ...
    public static void main(String[] argv) {
        try {
            AppGameContainer container = new AppGameContainer((Game)new GraphicsTest());
