...
public class RenderZombie extends RenderBiped<EntityZombie> {
    ...
    public RenderZombie(RenderManager renderManagerIn) {
        ...
        if (layerrenderer instanceof LayerCustomHead) {
            ...
            addLayer((LayerRenderer)new LayerCustomHead(this.zombieVillagerModel.bipedHead));
        } 
        removeLayer((LayerRenderer)layerbipedarmor);
        addLayer((LayerRenderer)new LayerVillagerArmor(this));
