...
public class GuiRepair extends GuiContainer implements ICrafting {
    ...
    public GuiRepair(InventoryPlayer inventoryIn, World worldIn) {
        super((Container)new ContainerRepair(inventoryIn, worldIn, (EntityPlayer)Minecraft.thePlayer));
    ...
    private void renameItem() {
        ...
        Minecraft.thePlayer.sendQueue.addToSendQueue((Packet)new C17PacketCustomPayload("MC|ItemName", (new PacketBuffer(Unpooled.buffer())).writeString(s)));
    }
