...
public class CustomPanoramaProperties {
    ...
    public CustomPanoramaProperties(String p_i40_1_, Properties p_i40_2_) {
        ...
        for (int i = 0; i < this.panoramaLocations.length; i++)
            this.panoramaLocations[i] = new ResourceLocation(String.valueOf(p_i40_1_) + "/panorama_" + i + ".png"); 
        ...
        this.overlay2Bottom = ConnectedParser.parseColor4(p_i40_2_.getProperty("overlay2.bottom"), -2147483648);
    }
