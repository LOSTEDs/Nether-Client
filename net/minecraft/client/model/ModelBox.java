...
public class ModelBox {
    ...
    public ModelBox(ModelRenderer p_i2_1_, int[][] p_i2_2_, float p_i2_3_, float p_i2_4_, float p_i2_5_, float p_i2_6_, float p_i2_7_, float p_i2_8_, float p_i2_9_, boolean p_i2_10_) {
        ...
        this.quadList[0] = makeTexturedQuad(new PositionTextureVertex[] { positiontexturevertex4, positiontexturevertex, positiontexturevertex1, positiontexturevertex5 }, p_i2_2_[4], false, p_i2_1_.textureWidth, p_i2_1_.textureHeight);
        this.quadList[1] = makeTexturedQuad(new PositionTextureVertex[] { positiontexturevertex7, positiontexturevertex3, positiontexturevertex6, positiontexturevertex2 }, p_i2_2_[5], false, p_i2_1_.textureWidth, p_i2_1_.textureHeight);
        this.quadList[2] = makeTexturedQuad(new PositionTextureVertex[] { positiontexturevertex4, positiontexturevertex3, positiontexturevertex7, positiontexturevertex }, p_i2_2_[1], true, p_i2_1_.textureWidth, p_i2_1_.textureHeight);
        this.quadList[3] = makeTexturedQuad(new PositionTextureVertex[] { positiontexturevertex1, positiontexturevertex2, positiontexturevertex6, positiontexturevertex5 }, p_i2_2_[0], true, p_i2_1_.textureWidth, p_i2_1_.textureHeight);
        this.quadList[4] = makeTexturedQuad(new PositionTextureVertex[] { positiontexturevertex, positiontexturevertex7, positiontexturevertex2, positiontexturevertex1 }, p_i2_2_[2], false, p_i2_1_.textureWidth, p_i2_1_.textureHeight);
        this.quadList[5] = makeTexturedQuad(new PositionTextureVertex[] { positiontexturevertex3, positiontexturevertex4, positiontexturevertex5, positiontexturevertex6 }, p_i2_2_[3], false, p_i2_1_.textureWidth, p_i2_1_.textureHeight);
        if (p_i2_10_) {
            byte b;
            int i;
