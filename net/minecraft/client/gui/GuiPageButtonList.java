...
public class GuiPageButtonList extends GuiListExtended {
    ...
    private void func_178069_s() {
        ...
        for (i = (arrayOfGuiListEntry = this.field_178078_x).length, b = 0; b < i; ) {
    ...
    private void func_178060_e(int p_178060_1_, int p_178060_2_) {
        ...
        int i;
        GuiListEntry[] arrayOfGuiListEntry;
        for (i = (arrayOfGuiListEntry = this.field_178078_x[p_178060_1_]).length, b = 0; b < i; ) {
        ...
        for (i = (arrayOfGuiListEntry = this.field_178078_x[p_178060_2_]).length, b = 0; b < i; ) {
