...
public class NetHandlerPlayClient implements INetHandlerPlayClient {
    ...
    public void handleMultiBlockChange(S22PacketMultiBlockChange packetIn) {
        ...
        for (i = (arrayOfBlockUpdateData = packetIn.getChangedBlocks()).length, b = 0; b < i; ) {
            S22PacketMultiBlockChange.BlockUpdateData s22packetmultiblockchange$blockupdatedata = arrayOfBlockUpdateData[b];
    ...
    public void handleSignEditorOpen(S36PacketSignEditorOpen packetIn) {
        ...
        Minecraft.thePlayer.openEditSign(tileEntitySign);
    }
    ...
    public void handleUpdateSign(S33PacketUpdateSign packetIn) {
        ...
        if (!flag && Minecraft.thePlayer != null)
            Minecraft.thePlayer.addChatMessage((IChatComponent)new ChatComponentText("Unable to locate sign at " + packetIn.getPos().getX() + ", " + packetIn.getPos().getY() + ", " + packetIn.getPos().getZ())); 
    }
    ...
    public void handleStatistics(S37PacketStatistics packetIn) {
        ...
        for (Map.Entry<StatBase, Integer> entry : (Iterable<Map.Entry<StatBase, Integer>>)packetIn.func_148974_c().entrySet()) {
            ...
            Minecraft.thePlayer.getStatFileWriter().unlockAchievement((EntityPlayer)Minecraft.thePlayer, statbase, i);
        } 
    ...
    public void handleCombatEvent(S42PacketCombatEvent packetIn) {
        ...
        if (packetIn.eventType == S42PacketCombatEvent.Event.END_COMBAT) {
            ...
            MetadataCombat metadatacombat = new MetadataCombat((EntityLivingBase)Minecraft.thePlayer, entitylivingbase);
                        ...
                        public void run() {
                            NetHandlerPlayClient.this.gameController.displayGuiScreen((GuiScreen)new GuiYesNo(new GuiYesNoCallback() {
                                            public void confirmClicked(boolean result, int id) {
                                                ...
                                                if (result) {
                                                    if ((NetHandlerPlayClient.null.access$0(NetHandlerPlayClient.null.this)).gameController.getCurrentServerData() != null)
                                                        (NetHandlerPlayClient.null.access$0(NetHandlerPlayClient.null.this)).gameController.getCurrentServerData().setResourceMode(ServerData.ServerResourceMode.ENABLED); 
                                                    (NetHandlerPlayClient.null.access$0(NetHandlerPlayClient.null.this)).netManager.sendPacket((Packet)new C19PacketResourcePackStatus(s1, C19PacketResourcePackStatus.Action.ACCEPTED));
                                                    Futures.addCallback((NetHandlerPlayClient.null.access$0(NetHandlerPlayClient.null.this)).gameController.getResourcePackRepository().downloadResourcePack(s, s1), new FutureCallback<Object>() {
                                                                public void onSuccess(Object p_onSuccess_1_) {
                                                                    (NetHandlerPlayClient.null.access$0(NetHandlerPlayClient.null.null.access$0(NetHandlerPlayClient.null.null.this))).netManager.sendPacket((Packet)new C19PacketResourcePackStatus(s1, C19PacketResourcePackStatus.Action.SUCCESSFULLY_LOADED));
                                                                }
                                                                
                                                                public void onFailure(Throwable p_onFailure_1_) {
                                                                    (NetHandlerPlayClient.null.access$0(NetHandlerPlayClient.null.null.access$0(NetHandlerPlayClient.null.null.this))).netManager.sendPacket((Packet)new C19PacketResourcePackStatus(s1, C19PacketResourcePackStatus.Action.FAILED_DOWNLOAD));
                                                                }
                                                            });
                                                } else {
                                                    if ((NetHandlerPlayClient.null.access$0(NetHandlerPlayClient.null.this)).gameController.getCurrentServerData() != null)
                                                        (NetHandlerPlayClient.null.access$0(NetHandlerPlayClient.null.this)).gameController.getCurrentServerData().setResourceMode(ServerData.ServerResourceMode.DISABLED); 
                                                    (NetHandlerPlayClient.null.access$0(NetHandlerPlayClient.null.this)).netManager.sendPacket((Packet)new C19PacketResourcePackStatus(s1, C19PacketResourcePackStatus.Action.DECLINED));
                                                } 
                                                ServerList.func_147414_b((NetHandlerPlayClient.null.access$0(NetHandlerPlayClient.null.this)).gameController.getCurrentServerData());
    ...
    public void handleCustomPayload(S3FPacketCustomPayload packetIn) {
        ...
        if ("MC|TrList".equals(packetIn.getChannelName())) {
            ...
            if (itemstack != null && itemstack.getItem() == Items.written_book)
                this.gameController.displayGuiScreen((GuiScreen)new GuiScreenBook((EntityPlayer)Minecraft.thePlayer, itemstack, false)); 
        } 
    }
