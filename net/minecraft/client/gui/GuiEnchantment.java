...
public class GuiEnchantment extends GuiContainer {
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
        ...
        for (int k = 0; k < 3; k++) {
            ...
            if (l >= 0 && i1 >= 0 && l < 108 && i1 < 19 && this.container.enchantItem((EntityPlayer)Minecraft.thePlayer, k))
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        for (int l = 0; l < 3; l++) {
            ...
            if (l1 == 0) {
                ...
                int i2 = 6839882;
                if ((k < l + 1 || Minecraft.thePlayer.experienceLevel < l1) && !Minecraft.thePlayer.capabilities.isCreativeMode) {
                    drawTexturedModalRect(i1, j + 14 + 19 * l, 0, 185, 108, 19);
                ...
                fontrenderer.drawStringWithShadow(m, (j1 + 86 - fontrenderer.getStringWidth(m)), (j + 16 + 19 * l + 7), i2);
            } 
        } 
    }
        ...
        for (int j = 0; j < 3; j++) {
            ...
            if (isPointInRegion(60, 14 + 19 * j, 108, 17, mouseX, mouseY) && k > 0 && l >= 0) {
                ...
                if (l >= 0 && Enchantment.getEnchantmentById(l & 0xFF) != null) {
                    ...
                    list.add(String.valueOf(EnumChatFormatting.WHITE.toString()) + EnumChatFormatting.ITALIC.toString() + I18n.format("container.enchant.clue", new Object[] { s }));
                } 
                if (!flag) {
                    if (l >= 0)
                        list.add(""); 
