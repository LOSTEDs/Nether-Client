...
public class PlayerControllerMP {
    ...
    public static void clickBlockCreative(Minecraft mcIn, PlayerControllerMP p_178891_1_, BlockPos p_178891_2_, EnumFacing p_178891_3_) {
        if (!mcIn.theWorld.extinguishFire((EntityPlayer)Minecraft.thePlayer, p_178891_2_, p_178891_3_))
    ...
    public boolean onPlayerDestroyBlock(BlockPos pos, EnumFacing side) {
        ...
        if (this.currentGameType.isCreative() && Minecraft.thePlayer.getHeldItem() != null && Minecraft.thePlayer.getHeldItem().getItem() instanceof net.minecraft.item.ItemSword)
            return false; 
        ...
        if (!this.currentGameType.isCreative()) {
            ...
            if (itemstack1 != null) {
                itemstack1.onBlockDestroyed(world, block1, pos, (EntityPlayer)Minecraft.thePlayer);
    ...
    public boolean clickBlock(BlockPos loc, EnumFacing face) {
        ...
        if (this.currentGameType.isCreative()) {
            ...
            if (flag && this.curBlockDamageMP == 0.0F)
                block1.onBlockClicked(this.mc.theWorld, loc, (EntityPlayer)Minecraft.thePlayer); 
            if (flag && block1.getPlayerRelativeBlockHardness((EntityPlayer)Minecraft.thePlayer, Minecraft.thePlayer.worldObj, loc) >= 1.0F) {
    ...
    public boolean onPlayerDamageBlock(BlockPos posBlock, EnumFacing directionFacing) {
        ...
        if (isHittingPosition(posBlock)) {
            ...
            this.curBlockDamageMP += block.getPlayerRelativeBlockHardness((EntityPlayer)Minecraft.thePlayer, Minecraft.thePlayer.worldObj, posBlock);
    ...
    public boolean isRidingHorse() {
        return (Minecraft.thePlayer.isRiding() && Minecraft.thePlayer.ridingEntity instanceof net.minecraft.entity.passive.EntityHorse);
    }
