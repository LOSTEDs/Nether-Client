...
public enum ModelRotation implements IModelState, ITransformation {
    ...
    static {
        ...
        for (i = (arrayOfModelRotation = values()).length, b = 0; b < i; ) {
            ModelRotation modelrotation = arrayOfModelRotation[b];
    ...
    ModelRotation(String p_i14_3_, int p_i14_4_, int p_i14_5_, int p_i14_6_) {
        ...
        Matrix4f.rotate(-p_i14_5_ * 0.017453292F, new Vector3f(1.0F, 0.0F, 0.0F), matrix4f, matrix4f);
        this.quartersX = MathHelper.abs_int(p_i14_5_ / 90);
        Matrix4f matrix4f1 = new Matrix4f();
        matrix4f1.setIdentity();
        Matrix4f.rotate(-p_i14_6_ * 0.017453292F, new Vector3f(0.0F, 1.0F, 0.0F), matrix4f1, matrix4f1);
