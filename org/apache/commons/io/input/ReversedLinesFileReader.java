...
public class ReversedLinesFileReader implements Closeable {
    ...
    public ReversedLinesFileReader(Path file, int blockSize, Charset charset) throws IOException {
        ...
        if (maxBytesPerChar == 1.0F) {
            ...
            this.byteDecrement = 1;
        } else if (this.encoding == Charset.forName("Shift_JIS") || this.encoding == 
            
            Charset.forName("windows-31j") || this.encoding == 
            Charset.forName("x-windows-949") || this.encoding == 
            Charset.forName("gbk") || this.encoding == 
