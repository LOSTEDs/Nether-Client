...
public class JsonToNBT {
    ...
    static Any func_150316_a(String p_150316_0_, String p_150316_1_) throws NBTException {
        ...
        if (p_150316_1_.startsWith("{")) {
            ...
            for (Compound jsontonbt$compound = new Compound(p_150316_0_); p_150316_1_.length() > 0; p_150316_1_ = p_150316_1_.substring(s1.length() + 1)) {
        ...
        if (p_150316_1_.startsWith("[") && !field_179273_b.matcher(p_150316_1_).matches()) {
            p_150316_1_ = p_150316_1_.substring(1, p_150316_1_.length() - 1);
            for (List jsontonbt$list = new List(p_150316_0_); p_150316_1_.length() > 0; p_150316_1_ = p_150316_1_.substring(s.length() + 1)) {
