            ...
            this.statSorter = new Comparator<StatCrafting>() {
                    public int compare(StatCrafting p_compare_1_, StatCrafting p_compare_2_) {
                        ...
                        if (statbase != null || statbase1 != null) {
                            ...
                            if (statbase1 == null)
                                return -1; 
                            int l = (GuiStats.StatsBlock.access$0(GuiStats.StatsBlock.this)).field_146546_t.readStat(statbase);
                            int i1 = (GuiStats.StatsBlock.access$0(GuiStats.StatsBlock.this)).field_146546_t.readStat(statbase1);
                            if (l != i1)
            ...
            this.statSorter = new Comparator<StatCrafting>() {
                    public int compare(StatCrafting p_compare_1_, StatCrafting p_compare_2_) {
                        ...
                        if (statbase != null || statbase1 != null) {
                            ...
                            if (statbase1 == null)
                                return -1; 
                            int l = (GuiStats.StatsItem.access$0(GuiStats.StatsItem.this)).field_146546_t.readStat(statbase);
                            int i1 = (GuiStats.StatsItem.access$0(GuiStats.StatsItem.this)).field_146546_t.readStat(statbase1);
                            if (l != i1)
