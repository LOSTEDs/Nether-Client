...
public class Shaders {
    ...
    private static final String[] programNames = new String[] { 
            ...
            "shadow", "shadow_solid", "shadow_cutout", "deferred", "deferred1", "deferred2", "deferred3", "deferred4", "deferred5", "deferred6", 
            "deferred7", "gbuffers_hand_water", "deferred_last", "composite_last" };
    ...
    private static CustomTexture loadCustomTexture(int index, String path) {
        ...
        try {
            ...
            CustomTexture customtexture = new CustomTexture(index, s, (ITextureObject)simpleshadertexture);
        ...
        if (!isShaderPackInitialized) {
            ...
            for (int k1 = 0; k1 < 44; k1++) {
                ...
                if (s1.equals("")) {
                    ...
                    int j = setupProgram(k1, String.valueOf(s3) + ".vsh", String.valueOf(s3) + ".fsh");
                    if (j > 0)
            ...
            try {
                ...
                while (true) {
                    ...
                    if (shaderline != null) {
                        ...
                        if (shaderline.isAttribute("mc_midTexCoord")) {
                            useMidTexCoordAttrib = true;
                            progUseMidTexCoordAttrib = true;
                            continue;
                        } 
                        if (s.contains("gl_MultiTexCoord3")) {
                            useMultiTexCoord3Attrib = true;
                            continue;
                        } 
                        if (shaderline.isAttribute("at_tangent")) {
                ...
                while (true) {
                    ...
                    if (shaderline != null) {
                        if (shaderline.isUniform()) {
                            ...
                            if ((k1 = ShaderParser.getShadowColorIndex(s5)) >= 0) {
                                usedShadowColorBuffers = Math.max(usedShadowColorBuffers, k1 + 1);
                                continue;
                            } 
                            if ((k1 = ShaderParser.getDepthIndex(s5)) >= 0) {
                            ...
                            if ((k1 = ShaderParser.getColorIndex(s5)) >= 0) {
                                usedColorBuffers = Math.max(usedColorBuffers, k1 + 1);
                                continue;
                            } 
                            if (s5.equals("centerDepthSmooth"))
    ...
    private static void setupFrameBuffer() {
        ...
        for (int k = 0; k < usedColorBuffers; k++) {
            ...
            GL11.glTexImage2D(3553, 0, gbuffersFormat[k], renderWidth, renderHeight, 0, 32993, 33639, null);
        ...
        for (int l = 0; l < usedColorBuffers; l++) {
            ...
            GL11.glTexParameteri(3553, 10241, 9729);
            GL11.glTexParameteri(3553, 10240, 9729);
            GL11.glTexImage2D(3553, 0, gbuffersFormat[l], renderWidth, renderHeight, 0, 32993, 33639, null);
            checkGLError("FT ca");
        } 
        ...
        if (entity != null) {
            ...
            if (Minecraft.thePlayer != null) {
                ...
                if (Minecraft.thePlayer.isPotionActive(Potion.nightVision))
                    nightVision = (Config.getMinecraft()).entityRenderer.getNightVisionBrightness((EntityLivingBase)Minecraft.thePlayer, partialTicks); 
                blindness = 0.0F;
