...
public class GuiControls extends GuiScreen {
    ...
    public void initGui() {
        ...
        for (j = (arrayOfOptions = optionsArr).length, b = 0; b < j; ) {
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        if (button.id == 200) {
            ...
            for (i = (arrayOfKeyBinding = this.mc.gameSettings.keyBindings).length, b = 0; b < i; ) {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        int i;
        KeyBinding[] arrayOfKeyBinding;
        for (i = (arrayOfKeyBinding = this.options.keyBindings).length, b = 0; b < i; ) {
            KeyBinding keybinding = arrayOfKeyBinding[b];
