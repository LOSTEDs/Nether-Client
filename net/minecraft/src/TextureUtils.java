...
public class TextureUtils {
    ...
    public static void update() {
        ...
        if (texturemap != null) {
            ...
            iconGrassTop = texturemap.getSpriteSafe(String.valueOf(s) + "grass_top");
            iconGrassSide = texturemap.getSpriteSafe(String.valueOf(s) + "grass_side");
            iconGrassSideOverlay = texturemap.getSpriteSafe(String.valueOf(s) + "grass_side_overlay");
            iconSnow = texturemap.getSpriteSafe(String.valueOf(s) + "snow");
            iconGrassSideSnowed = texturemap.getSpriteSafe(String.valueOf(s) + "grass_side_snowed");
            iconMyceliumSide = texturemap.getSpriteSafe(String.valueOf(s) + "mycelium_side");
            iconMyceliumTop = texturemap.getSpriteSafe(String.valueOf(s) + "mycelium_top");
            iconWaterStill = texturemap.getSpriteSafe(String.valueOf(s) + "water_still");
            iconWaterFlow = texturemap.getSpriteSafe(String.valueOf(s) + "water_flow");
            iconLavaStill = texturemap.getSpriteSafe(String.valueOf(s) + "lava_still");
            iconLavaFlow = texturemap.getSpriteSafe(String.valueOf(s) + "lava_flow");
            iconFireLayer0 = texturemap.getSpriteSafe(String.valueOf(s) + "fire_layer_0");
            iconFireLayer1 = texturemap.getSpriteSafe(String.valueOf(s) + "fire_layer_1");
            iconPortal = texturemap.getSpriteSafe(String.valueOf(s) + "portal");
            iconGlass = texturemap.getSpriteSafe(String.valueOf(s) + "glass");
            iconGlassPaneTop = texturemap.getSpriteSafe(String.valueOf(s) + "glass_pane_top");
            String s1 = "minecraft:items/";
            iconCompass = texturemap.getSpriteSafe(String.valueOf(s1) + "compass");
            iconClock = texturemap.getSpriteSafe(String.valueOf(s1) + "clock");
        } 
    }
    ...
    public static int ceilPowerOfTwo(int p_ceilPowerOfTwo_0_) {
        for (int i = 1; i < p_ceilPowerOfTwo_0_; i *= 2);
        return i;
    }
    
    public static int getPowerOfTwo(int p_getPowerOfTwo_0_) {
        int i = 1;
        for (int j = 0; i < p_getPowerOfTwo_0_; j++)
            i *= 2; 
        return j;
    }
