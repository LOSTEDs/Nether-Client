...
public class GuiStreamOptions extends GuiScreen {
    ...
    public void initGui() {
        ...
        for (j = (arrayOfOptions = field_152312_a).length, b = 0; b < j; ) {
        ...
        i += 2;
        for (j = (arrayOfOptions = field_152316_f).length, b = 0; b < j; ) {
            GameSettings.Options gamesettings$options1 = arrayOfOptions[b];
