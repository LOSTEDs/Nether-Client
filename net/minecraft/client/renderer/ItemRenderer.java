...
public class ItemRenderer {
    ...
    private void renderRightArm(RenderPlayer renderPlayerIn) {
        ...
        renderPlayerIn.renderRightArm((AbstractClientPlayer)Minecraft.thePlayer);
        GlStateManager.popMatrix();
    }
    ...
    private void renderLeftArm(RenderPlayer renderPlayerIn) {
        ...
        renderPlayerIn.renderLeftArm((AbstractClientPlayer)Minecraft.thePlayer);
        GlStateManager.popMatrix();
    }
    
    private void renderPlayerArms(AbstractClientPlayer clientPlayer) {
        this.mc.getTextureManager().bindTexture(clientPlayer.getLocationSkin());
        Render render = this.renderManager.getEntityRenderObject((Entity)Minecraft.thePlayer);
    ...
    private void func_178095_a(AbstractClientPlayer clientPlayer, float p_178095_2_, float p_178095_3_) {
        ...
        GlStateManager.disableCull();
        RenderPlayer renderplayer = (RenderPlayer)render;
        renderplayer.renderRightArm((AbstractClientPlayer)Minecraft.thePlayer);
        GlStateManager.enableCull();
    }
    ...
    private void transformFirstPersonItem(float equipProgress, float swingProgress) {
        if (HudManager.itemModel.isEnabled()) {
    ...
    public void renderItemInFirstPerson(float partialTicks) {
        ...
        GlStateManager.pushMatrix();
        if (HudManager.oldAnimations.isEnabled()) {
            if (this.itemToRender != null) {
                if (this.itemToRender.getItem() instanceof net.minecraft.item.ItemMap) {
                    renderItemMap((AbstractClientPlayer)entityplayersp, f3, f, f2);
                    ...
                    switch (ItemRenderer$1.field_178094_a[enumaction.ordinal()]) {
                        ...
                        case 3:
                            ...
                            break;
                        case 4:
                            transformFirstPersonItem(0.2F, f2);
                            func_178103_d();
                            GlStateManager.translate(-0.5F, 0.2F, 0.0F);
                            break;
                        case 5:
                ...
                func_178095_a((AbstractClientPlayer)entityplayersp, f, f2);
            } 
    ...
    public void renderOverlays(float partialTicks) {
        ...
        if (Minecraft.thePlayer.isEntityInsideOpaqueBlock()) {
            IBlockState iblockstate = this.mc.theWorld.getBlockState(new BlockPos((Entity)Minecraft.thePlayer));
            BlockPos blockpos = new BlockPos((Entity)Minecraft.thePlayer);
            EntityPlayerSP entityplayersp = Minecraft.thePlayer;
            for (int i = 0; i < 8; i++) {
            ...
            if (iblockstate.getBlock().getRenderType() != -1) {
                ...
                if (!Reflector.callBoolean(Reflector.ForgeEventFactory_renderBlockOverlay, new Object[] { Minecraft.thePlayer, Float.valueOf(partialTicks), object, iblockstate, blockpos }))
        ...
        if (!Minecraft.thePlayer.isSpectator()) {
            if (Minecraft.thePlayer.isInsideOfMaterial(Material.water) && !Reflector.callBoolean(Reflector.ForgeEventFactory_renderWaterOverlay, new Object[] { Minecraft.thePlayer, Float.valueOf(partialTicks) }))
                renderWaterOverlayTexture(partialTicks); 
            if (Minecraft.thePlayer.isBurning() && !Reflector.callBoolean(Reflector.ForgeEventFactory_renderFireOverlay, new Object[] { Minecraft.thePlayer, Float.valueOf(partialTicks) }))
