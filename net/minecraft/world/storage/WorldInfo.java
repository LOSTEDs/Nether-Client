...
public class WorldInfo {
    ...
    public void addToCrashReport(CrashReportCategory category) {
        ...
        category.addCrashSectionCallable("Level generator", new Callable<String>() {
                    public String call() throws Exception {
                        return String.format("ID %02d - %s, ver %d. Features enabled: %b", new Object[] { Integer.valueOf(WorldInfo.access$0(this.this$0).getWorldTypeID()), WorldInfo.access$0(this.this$0).getWorldTypeName(), Integer.valueOf(WorldInfo.access$0(this.this$0).getGeneratorVersion()), Boolean.valueOf(WorldInfo.access$1(this.this$0)) });
                    }
                });
        ...
        category.addCrashSectionCallable("Level time", new Callable<String>() {
                    public String call() throws Exception {
                        return String.format("%d game time, %d day time", new Object[] { Long.valueOf(WorldInfo.access$6(this.this$0)), Long.valueOf(WorldInfo.access$7(this.this$0)) });
                    }
                });
        ...
        category.addCrashSectionCallable("Level storage version", new Callable<String>() {
                    public String call() throws Exception {
                        ...
                        return String.format("0x%05X - %s", new Object[] { Integer.valueOf(WorldInfo.access$9(this.this$0)), s });
                    }
                });
        category.addCrashSectionCallable("Level weather", new Callable<String>() {
                    public String call() throws Exception {
                        return String.format("Rain time: %d (now: %b), thunder time: %d (now: %b)", new Object[] { Integer.valueOf(WorldInfo.access$10(this.this$0)), Boolean.valueOf(WorldInfo.access$11(this.this$0)), Integer.valueOf(WorldInfo.access$12(this.this$0)), Boolean.valueOf(WorldInfo.access$13(this.this$0)) });
                    }
                });
        category.addCrashSectionCallable("Level game mode", new Callable<String>() {
                    public String call() throws Exception {
                        return String.format("Game mode: %s (ID %d). Hardcore: %b. Cheats: %b", new Object[] { WorldInfo.access$14(this.this$0).getName(), Integer.valueOf(WorldInfo.access$14(this.this$0).getID()), Boolean.valueOf(WorldInfo.access$15(this.this$0)), Boolean.valueOf(WorldInfo.access$16(this.this$0)) });
                    }
                });
    }
