...
public class GameSettings {
    ...
    public KeyBinding Click_GUI = new KeyBinding("Mods Settings", 24, Client.ClientName);
    
    public KeyBinding HUD_Config = new KeyBinding("Mods Position", 54, Client.ClientName);
    
    public KeyBinding Perspective = new KeyBinding("Perspective (Free Look)", 33, Client.ClientName);
    ...
    private void addClientKeybinds() {
        this.keyBindings = (KeyBinding[])ArrayUtils.add((Object[])this.keyBindings, this.Click_GUI);
        this.keyBindings = (KeyBinding[])ArrayUtils.add((Object[])this.keyBindings, this.HUD_Config);
        this.keyBindings = (KeyBinding[])ArrayUtils.add((Object[])this.keyBindings, this.Perspective);
    }
    ...
    public String getKeyBinding(Options p_74297_1_) {
        ...
        if (p_74297_1_ == Options.GUI_SCALE)
            return String.valueOf(s1) + getTranslation(GUISCALES, this.guiScale); 
        ...
        if (p_74297_1_ == Options.PARTICLES)
            return String.valueOf(s1) + getTranslation(PARTICLES, this.particleSetting); 
        if (p_74297_1_ == Options.AMBIENT_OCCLUSION)
            return String.valueOf(s1) + getTranslation(AMBIENT_OCCLUSIONS, this.ambientOcclusion); 
        if (p_74297_1_ == Options.STREAM_COMPRESSION)
            return String.valueOf(s1) + getTranslation(STREAM_COMPRESSIONS, this.streamCompression); 
        if (p_74297_1_ == Options.STREAM_CHAT_ENABLED)
            return String.valueOf(s1) + getTranslation(STREAM_CHAT_MODES, this.streamChatEnabled); 
        if (p_74297_1_ == Options.STREAM_CHAT_USER_FILTER)
            return String.valueOf(s1) + getTranslation(STREAM_CHAT_FILTER_MODES, this.streamChatUserFilter); 
        if (p_74297_1_ == Options.STREAM_MIC_TOGGLE_BEHAVIOR)
            return String.valueOf(s1) + getTranslation(STREAM_MIC_MODES, this.streamMicToggleBehavior); 
        if (p_74297_1_ == Options.RENDER_CLOUDS)
            return String.valueOf(s1) + getTranslation(field_181149_aW, this.clouds); 
            ...
            while ((s = bufferedreader.readLine()) != null) {
                try {
                    ...
                    if (astring[0].equals("resourcePacks")) {
                        this.resourcePacks = (List<String>)gson.fromJson(s.substring(s.indexOf(':') + 1), typeListString);
                    ...
                    for (i = (arrayOfKeyBinding = this.keyBindings).length, b = 0; b < i; ) {
                    ...
                    for (i = (arrayOfSoundCategory = SoundCategory.values()).length, b = 0; b < i; ) {
                    ...
                    for (i = (arrayOfEnumPlayerModelParts = EnumPlayerModelParts.values()).length, b = 0; b < i; ) {
    ...
    public void sendSettingsToServer() {
        if (Minecraft.thePlayer != null) {
            ...
            Minecraft.thePlayer.sendQueue.addToSendQueue((Packet)new C15PacketClientSettings(this.language, this.renderDistanceChunks, this.chatVisibility, this.chatColours, i));
        } 
    }
    ...
    private String getKeyBindingOF(Options p_getKeyBindingOF_1_) {
        ...
        if (p_getKeyBindingOF_1_ == Options.DYNAMIC_LIGHTS) {
            ...
            return String.valueOf(s) + getTranslation(KEYS_DYNAMIC_LIGHTS, k);
        } 
    ...
    public enum Options {
        ...
        public static Options getEnumOptions(int p_74379_0_) {
            ...
            for (i = (arrayOfOptions = values()).length, b = 0; b < i; ) {
                Options gamesettings$options = arrayOfOptions[b];
