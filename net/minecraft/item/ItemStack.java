...
public final class ItemStack {
    ...
    public List<String> getTooltip(EntityPlayer playerIn, boolean advanced) {
        ...
        if (advanced) {
            ...
            if (getHasSubtypes()) {
                s = String.valueOf(s) + String.format("#%04d/%d%s", new Object[] { Integer.valueOf(i), Integer.valueOf(this.itemDamage), s1 });
            } else {
                s = String.valueOf(s) + String.format("#%04d%s", new Object[] { Integer.valueOf(i), s1 });
            } 
