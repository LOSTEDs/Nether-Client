...
public class SmartLeaves {
    ...
    public static boolean isSameLeaves(IBlockState p_isSameLeaves_0_, IBlockState p_isSameLeaves_1_) {
        ...
        return (block != block1) ? false : ((block instanceof BlockOldLeaf) ? ((BlockPlanks.EnumType)p_isSameLeaves_0_.getValue((IProperty)BlockOldLeaf.VARIANT)).equals(p_isSameLeaves_1_.getValue((IProperty)BlockOldLeaf.VARIANT)) : ((block instanceof BlockNewLeaf) ? ((BlockPlanks.EnumType)p_isSameLeaves_0_.getValue((IProperty)BlockNewLeaf.VARIANT)).equals(p_isSameLeaves_1_.getValue((IProperty)BlockNewLeaf.VARIANT)) : false));
    }
