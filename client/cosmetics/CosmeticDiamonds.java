...
public class CosmeticDiamonds extends CosmeticBase {
    private final CosmeticVilligerNose2 EggsModel;
    
    public CosmeticDiamonds(RenderPlayer renderPlayer) {
        super(renderPlayer);
    ...
    public void render(AbstractClientPlayer player, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
        ...
        if (player == Minecraft.thePlayer && HudManager.cosmeticDiamonds.isEnabled())
            this.EggsModel.render((Entity)player, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch, scale); 
        GL11.glPopMatrix();
    }
    ...
    public class CosmeticVilligerNose2 extends CosmeticModelBase {
        ...
        public void render(Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float headYaw, float headPitch, float scale) {
            ...
            ItemStack itemsword = new ItemStack(Items.diamond);
