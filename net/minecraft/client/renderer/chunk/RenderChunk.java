...
public class RenderChunk {
    ...
    public void rebuildChunk(float x, float y, float z, ChunkCompileTaskGenerator generator) {
        ...
        if (!regionrendercache.extendedLevelsInChunkCache()) {
            ...
            while (iterator.hasNext()) {
                ...
                for (int j = 0; j < aenumworldblocklayer.length; j++) {
                    ...
                    if (block.getRenderType() != -1) {
                        ...
                        aboolean[k] = aboolean[k] | blockrendererdispatcher.renderBlock(iblockstate, (BlockPos)blockposm, (IBlockAccess)regionrendercache, worldrenderer);
                    } 
                    continue;
                } 
            } 
            ...
            for (i = (arrayOfEnumWorldBlockLayer = ENUM_WORLD_BLOCK_LAYERS).length, b = 0; b < i; ) {
                EnumWorldBlockLayer enumworldblocklayer1 = arrayOfEnumWorldBlockLayer[b];
