...
import client.utils.ClientMovementInput;
...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    private void startGame() throws LWJGLException, IOException {
        ...
        SplashProgress.setProgress(1, "Minecraft - SoundHandler");
        ...
        SplashProgress.setProgress(2, "Minecraft - FontRenderer");
        ...
        SplashProgress.setProgress(5, "Minecraft - RenderManager");
        ...
        SplashProgress.setProgress(8, "Minecraft - BlockRendererDispatcher");
        ...
        SplashProgress.setProgress(9, "Minecraft - RenderGlobal");
    ...
    private void setWindowIcon() {
        ...
        if (util$enumos != Util.EnumOS.OSX) {
            ...
            try {
                inputstream = this.mcDefaultResourcePack.getResourceStream(new ResourceLocation("client/icon_16x16.png"));
                inputstream1 = this.mcDefaultResourcePack.getResourceStream(new ResourceLocation("client/icon_32x32.png"));
    ...
    private static boolean isJvm64bit() {
        ...
        for (i = (arrayOfString1 = astring).length, b = 0; b < i; ) {
    ...
    private void runGameLoop() throws IOException {
        ...
        this.mcSoundHandler.setListener((EntityPlayer)thePlayer, this.timer.renderPartialTicks);
        this.mcProfiler.endSection();
        ...
        if (list != null && !list.isEmpty()) {
            ...
            if (keyCount == 0) {
                ...
                if (keyCount < list.size() && !((Profiler.Result)list.get(keyCount)).field_76331_c.equals("unspecified")) {
                    ...
                    this.debugProfilerName = String.valueOf(this.debugProfilerName) + ((Profiler.Result)list.get(keyCount)).field_76331_c;
                } 
            } 
        } 
    }
    ...
    private void displayDebugInfo(long elapsedTicksTime) {
        if (this.mcProfiler.profilingEnabled) {
            ...
            this.fontRendererObj.drawStringWithShadow(s = String.valueOf(decimalformat.format(profiler$result.field_76330_b)) + "%", (j + i - this.fontRendererObj.getStringWidth(s)), (k - i / 2 - 16), l2);
            for (int k2 = 0; k2 < list.size(); k2++) {
                ...
                this.fontRendererObj.drawStringWithShadow(s1 = String.valueOf(decimalformat.format(profiler$result2.field_76332_a)) + "%", (j + i - 50 - this.fontRendererObj.getStringWidth(s1)), (k + i / 2 + k2 * 8 + 20), profiler$result2.func_76329_a());
                this.fontRendererObj.drawStringWithShadow(s1 = String.valueOf(decimalformat.format(profiler$result2.field_76330_b)) + "%", (j + i - this.fontRendererObj.getStringWidth(s1)), (k + i / 2 + k2 * 8 + 20), profiler$result2.func_76329_a());
            } 
        } 
    }
        ...
        if (this.leftClickCounter <= 0) {
            ...
            if (this.objectMouseOver == null) {
                ...
                switch (this.objectMouseOver.typeOfHit) {
                    case ENTITY:
                        this.playerController.attackEntity((EntityPlayer)thePlayer, this.objectMouseOver.entityHit);
                        return;
                    case null:
    ...
    private void rightClickMouse() {
        if (!this.playerController.func_181040_m()) {
            ...
            if (this.objectMouseOver == null) {
                ...
                switch (this.objectMouseOver.typeOfHit) {
                    case ENTITY:
                        if (this.playerController.func_178894_a((EntityPlayer)thePlayer, this.objectMouseOver.entityHit, this.objectMouseOver)) {
                            flag = false;
                            break;
                        } 
                        if (this.playerController.interactWithEntitySendPacket((EntityPlayer)thePlayer, this.objectMouseOver.entityHit))
                            flag = false; 
                        break;
                    case null:
                        blockpos = this.objectMouseOver.getBlockPos();
            ...
            if (flag) {
                ...
                if (itemstack1 != null && this.playerController.sendUseItem((EntityPlayer)thePlayer, (World)this.theWorld, itemstack1))
    ...
    public void runTick() throws IOException {
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput) {
                    ...
                    if (j != 0)
                        if (thePlayer.isSpectator()) {
                            ...
                            if (this.ingameGUI.getSpectatorGui().func_175262_a()) {
                                ...
                                float f = MathHelper.clamp_float(thePlayer.capabilities.getFlySpeed() + j * 0.005F, 0.0F, 0.2F);
                                thePlayer.capabilities.setFlySpeed(f);
                            } 
                        } else if (!Config.zoomMode || !HudManager.scrollZoom.isEnabled()) {
            ...
            while (this.gameSettings.keyBindInventory.isPressed()) {
                ...
                displayGuiScreen((GuiScreen)new GuiInventory((EntityPlayer)thePlayer));
            } 
            ...
            if (thePlayer.isUsingItem()) {
                if (!this.gameSettings.keyBindUseItem.isKeyDown())
                    this.playerController.onStoppedUsingItem((EntityPlayer)thePlayer); 
                do {
        ...
        if (this.theWorld != null) {
            if (thePlayer != null) {
                ...
                if (this.joinPlayerCounter == 30) {
                    ...
                    this.theWorld.joinEntityInSurroundings((Entity)thePlayer);
                } 
            } 
            this.mcProfiler.endStartSection("gameRenderer");
            if (!this.isGamePaused)
        ...
        if (this.theWorld != null) {
            ...
            if (!this.isGamePaused && this.theWorld != null)
                this.theWorld.doVoidFogParticles(MathHelper.floor_double(thePlayer.posX), MathHelper.floor_double(thePlayer.posY), MathHelper.floor_double(thePlayer.posZ)); 
    ...
    public void loadWorld(WorldClient worldClientIn, String loadingMessage) {
        ...
        if (worldClientIn != null) {
            ...
            if (thePlayer == null) {
                thePlayer = this.playerController.func_178892_a((World)worldClientIn, new StatFileWriter());
                this.playerController.flipPlayer((EntityPlayer)thePlayer);
            } 
            thePlayer.preparePlayerToSpawn();
            worldClientIn.spawnEntityInWorld((Entity)thePlayer);
            thePlayer.movementInput = new ClientMovementInput(this.gameSettings);
            this.playerController.setPlayerCapabilities((EntityPlayer)thePlayer);
            this.renderViewEntity = (Entity)thePlayer;
        } else {
    ...
    public void setDimensionAndSpawnPlayer(int dimension) {
        ...
        if (thePlayer != null) {
            ...
            this.theWorld.removeEntity((Entity)thePlayer);
            s = thePlayer.getClientBrand();
        } 
        this.renderViewEntity = null;
        EntityPlayerSP entityplayersp = thePlayer;
        thePlayer = this.playerController.func_178892_a((World)this.theWorld, (thePlayer == null) ? new StatFileWriter() : thePlayer.getStatFileWriter());
        ...
        this.theWorld.spawnEntityInWorld((Entity)thePlayer);
        this.playerController.flipPlayer((EntityPlayer)thePlayer);
        thePlayer.movementInput = new ClientMovementInput(this.gameSettings);
