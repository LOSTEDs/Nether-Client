...
public class CosmeticsMenu extends GuiScreen {
    ...
    public void initGui() {
        super.initGui();
        this.modButtons.add(new ModButton(this.width / 2 + 25, this.height / 2 - 125, 65, this.fontRendererObj.FONT_HEIGHT + 4, (HudMod)HudManager.cosmeticWings));
        this.modButtons.add(new ModButton(this.width / 2 + 105, this.height / 2 - 125, 67, this.fontRendererObj.FONT_HEIGHT + 4, (HudMod)HudManager.rainbowWings));
        this.modButtons.add(new ModButton(this.width / 2 + 25, this.height / 2 - 100, 67, this.fontRendererObj.FONT_HEIGHT + 4, (HudMod)HudManager.cosmeticDiamonds));
        this.modButtons.add(new ModButton(this.width / 2 + 105, this.height / 2 - 100, 52, this.fontRendererObj.FONT_HEIGHT + 4, (HudMod)HudManager.cosmeticEggs));
        this.modButtons.add(new ModButton(this.width / 2 + 25, this.height / 2 - 75, 60, this.fontRendererObj.FONT_HEIGHT + 4, (HudMod)HudManager.cosmeticHat));
        this.modButtons.add(new ModButton(this.width / 2 + 105, this.height / 2 - 75, 74, this.fontRendererObj.FONT_HEIGHT + 4, (HudMod)HudManager.cosmeticWither));
        this.modButtons.add(new ModButton(this.width / 2 + 25, this.height / 2 - 50, 70, this.fontRendererObj.FONT_HEIGHT + 4, (HudMod)HudManager.cosmeticCape));
        this.buttonList.add(new ClassicButton(1, this.width / 2 - 170, this.height / 2 + 70, 150, 20, I18n.format("Mods Settings", new Object[0])));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        drawCenteredString(this.fontRendererObj, I18n.format("Cosmetics Menu", new Object[0]), this.width / 2 - 100, this.height / 2 - 135, -1);
