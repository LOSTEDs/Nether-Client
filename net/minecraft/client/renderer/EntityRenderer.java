...
public class EntityRenderer implements IResourceManagerReloadListener {
    ...
    public void updateRenderer() {
        ...
        if (this.mc.getRenderViewEntity() == null)
            this.mc.setRenderViewEntity((Entity)Minecraft.thePlayer); 
    ...
    private int getScrollAmount() {
        if (HudManager.scrollZoom.isEnabled()) {
    ...
    private void orientCamera(float partialTicks) {
        ...
        if (entity instanceof EntityLivingBase && ((EntityLivingBase)entity).isPlayerSleeping()) {
            ...
            if (!this.mc.gameSettings.debugCamEnable) {
                ...
                GlStateManager.rotate(PerspectiveMod.getCameraYaw() + (PerspectiveMod.getCameraYaw() - PerspectiveMod.getCameraYaw()) * partialTicks + 180.0F, 0.0F, -1.0F, 0.0F);
                GlStateManager.rotate(PerspectiveMod.getCameraPitch() + (PerspectiveMod.getCameraPitch() - PerspectiveMod.getCameraPitch()) * partialTicks, -1.0F, 0.0F, 0.0F);
            } 
            ...
            if (this.mc.gameSettings.debugCamEnable) {
                ...
                float f1 = PerspectiveMod.getCameraYaw();
        ...
        if (Reflector.EntityViewRenderEvent_CameraSetup_Constructor.exists()) {
            if (!this.mc.gameSettings.debugCamEnable) {
                float f6 = PerspectiveMod.getCameraYaw() + (PerspectiveMod.getCameraYaw() - PerspectiveMod.getCameraYaw()) * partialTicks + 180.0F;
                float f7 = PerspectiveMod.getCameraPitch() + (PerspectiveMod.getCameraPitch() - PerspectiveMod.getCameraPitch()) * partialTicks;
                float f8 = 0.0F;
    ...
    public void setupCameraTransform(float partialTicks, int pass) {
        ...
        float f1 = Minecraft.thePlayer.prevTimeInPortal + (Minecraft.thePlayer.timeInPortal - Minecraft.thePlayer.prevTimeInPortal) * partialTicks;
        if (f1 > 0.0F) {
            byte b0 = 20;
    ...
    private void updateLightmap(float partialTicks) {
        if (this.lightmapUpdateNeeded) {
            ...
            if (worldclient != null) {
                if (Config.isCustomColors() && CustomColors.updateLightmap((World)worldclient, this.torchFlickerX, this.lightmapColors, Minecraft.thePlayer.isPotionActive(Potion.nightVision), partialTicks)) {
                ...
                for (int i = 0; i < 256; i++) {
                    ...
                    if (Minecraft.thePlayer.isPotionActive(Potion.nightVision)) {
                        float f15 = getNightVisionBrightness((EntityLivingBase)Minecraft.thePlayer, partialTicks);
                        float f12 = 1.0F / f8;
                        if (f12 > 1.0F / f9)
                            f12 = 1.0F / f9; 
                        if (f12 > 1.0F / f10)
    ...
    public void func_181560_a(float p_181560_1_, long p_181560_2_) {
        ...
        if (this.mc.inGameHasFocus && flag)
            if (PerspectiveMod.overriderMouse()) {
                ...
                if (this.mc.gameSettings.smoothCamera) {
                    ...
                    Minecraft.thePlayer.setAngles(f2, f3 * b0);
                } else {
                    this.smoothCamYaw = 0.0F;
                    this.smoothCamPitch = 0.0F;
                    Minecraft.thePlayer.setAngles(f2, f3 * b0);
    ...
    private void renderWorldPass(int pass, float partialTicks, long finishTimeNano) {
        ...
        ActiveRenderInfo.updateRenderInfo((EntityPlayer)Minecraft.thePlayer, (this.mc.gameSettings.thirdPersonView == 2));
        ...
        if (flag) {
            ShadersRender.setupTerrain(renderglobal, entity, partialTicks, (ICamera)frustum, this.frameCount++, Minecraft.thePlayer.isSpectator());
        } else {
            renderglobal.setupTerrain(entity, partialTicks, (ICamera)frustum, this.frameCount++, Minecraft.thePlayer.isSpectator());
        } 
        if (pass == 0 || pass == 2) {
    ...
    private void updateFogColor(float partialTicks) {
        ...
        if (this.cloudFog) {
            ...
            Vec3 vec35 = CustomColors.getUnderlavaColor((IBlockAccess)this.mc.theWorld, (this.mc.getRenderViewEntity()).posX, (this.mc.getRenderViewEntity()).posY + 1.0D, (this.mc.getRenderViewEntity()).posZ);
            if (vec35 != null) {
