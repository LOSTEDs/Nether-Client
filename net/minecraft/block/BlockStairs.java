...
public class BlockStairs extends Block {
    ...
    public MovingObjectPosition collisionRayTrace(World worldIn, BlockPos pos, Vec3 start, Vec3 end) {
        ...
        byte b1;
        int k, arrayOfInt1[];
        for (k = (arrayOfInt1 = aint).length, b1 = 0; b1 < k; ) {
            int n = arrayOfInt1[b1];
            amovingobjectposition[n] = null;
            b1++;
        } 
        ...
        for (m = (arrayOfMovingObjectPosition1 = amovingobjectposition).length, b2 = 0; b2 < m; ) {
            MovingObjectPosition movingobjectposition = arrayOfMovingObjectPosition1[b2];
