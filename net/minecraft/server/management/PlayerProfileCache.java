...
public class PlayerProfileCache {
    ...
    private void addEntry(GameProfile gameProfile, Date expirationDate) {
        ...
        ProfileEntry playerprofilecache$profileentry = new ProfileEntry(gameProfile, expirationDate, null);
            ...
            if (p_deserialize_1_.isJsonObject()) {
                ...
                if (jsonelement != null && jsonelement1 != null) {
                    ...
                    if (s1 != null && s != null) {
                        ...
                        PlayerProfileCache.ProfileEntry playerprofilecache$profileentry = new PlayerProfileCache.ProfileEntry(new GameProfile(uuid, s1), date, null);
                        return playerprofilecache$profileentry;
                    } 
                    return null;
                } 
