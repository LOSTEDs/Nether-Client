...
public class GuiPlayerTabOverlay extends Gui {
    private static final Ordering<NetworkPlayerInfo> field_175252_a = Ordering.from(new PlayerComparator(null));
        ...
        if (p_175247_1_.getRenderType() == IScoreObjectiveCriteria.EnumRenderType.HEARTS) {
            ...
            if (j > 0) {
                ...
                if (f > 3.0F) {
                    ...
                    float f2 = i / 2.0F;
                    if (p_175247_5_ - this.mc.fontRendererObj.getStringWidth(String.valueOf(f2) + "hp") >= p_175247_4_)
                        str = String.valueOf(f2) + "hp"; 
                    this.mc.fontRendererObj.drawStringWithShadow(str, ((p_175247_5_ + p_175247_4_) / 2 - this.mc.fontRendererObj.getStringWidth(str) / 2), p_175247_2_, i1);
                } 
            } 
        } else {
