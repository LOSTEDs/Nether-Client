...
public class LightMapPack {
    ...
    public boolean updateLightmap(World p_updateLightmap_1_, float p_updateLightmap_2_, int[] p_updateLightmap_3_, boolean p_updateLightmap_4_, float p_updateLightmap_5_) {
        ...
        if (i != 1 && i != -1) {
            ...
            int j = 0;
            int[][] aint = { p_updateLightmap_3_, this.colorBuffer1, this.colorBuffer2 };
    ...
    private boolean blend(int[] p_blend_1_, float p_blend_2_, int[] p_blend_3_, float p_blend_4_) {
        ...
        for (int i = 0; i < p_blend_1_.length; i++) {
            ...
            int l1 = j1 >> 8 & 0xFF;
            int i2 = j1 & 0xFF;
            int j2 = (int)(k * p_blend_2_ + k1 * p_blend_4_);
            int k2 = (int)(l * p_blend_2_ + l1 * p_blend_4_);
            int l2 = (int)(i1 * p_blend_2_ + i2 * p_blend_4_);
            p_blend_1_[i] = 0xFF000000 | j2 << 16 | k2 << 8 | l2;
        } 
        return true;
    }
    ...
    private boolean blend(int[] p_blend_1_, float p_blend_2_, int[] p_blend_3_, float p_blend_4_, int[] p_blend_5_, float p_blend_6_) {
        if (p_blend_3_.length == p_blend_1_.length && p_blend_5_.length == p_blend_1_.length) {
            for (int i = 0; i < p_blend_1_.length; i++) {
                ...
                int l2 = j2 >> 8 & 0xFF;
                int i3 = j2 & 0xFF;
                int j3 = (int)(k * p_blend_2_ + k1 * p_blend_4_ + k2 * p_blend_6_);
                int k3 = (int)(l * p_blend_2_ + l1 * p_blend_4_ + l2 * p_blend_6_);
                int l3 = (int)(i1 * p_blend_2_ + i2 * p_blend_4_ + i3 * p_blend_6_);
                p_blend_1_[i] = 0xFF000000 | j3 << 16 | k3 << 8 | l3;
            } 
            return true;
        } 
        return false;
