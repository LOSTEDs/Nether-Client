    ...
    public void applyAttributesModifiersToEntity(EntityLivingBase entityLivingBaseIn, BaseAttributeMap p_111185_2_, int amplifier) {
        for (Map.Entry<IAttribute, AttributeModifier> entry : this.attributeModifierMap.entrySet()) {
            ...
            if (iattributeinstance != null) {
                ...
                iattributeinstance.applyModifier(new AttributeModifier(attributemodifier.getID(), String.valueOf(getName()) + " " + amplifier, getAttributeModifierAmount(amplifier, attributemodifier), attributemodifier.getOperation()));
            } 
        } 
    }
