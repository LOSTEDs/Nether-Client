...
public class GuiContainerCreative extends InventoryEffectRenderer {
    ...
    public void updateScreen() {
        if (!this.mc.playerController.isInCreativeMode())
            this.mc.displayGuiScreen((GuiScreen)new GuiInventory((EntityPlayer)Minecraft.thePlayer)); 
    ...
    protected void handleMouseClick(Slot slotIn, int slotId, int clickedButton, int clickType) {
        ...
        if (slotIn == null && selectedTabIndex != CreativeTabs.tabInventory.getTabIndex() && clickType != 5) {
            ...
            if (slotIn == this.field_147064_C) {
                ...
                Minecraft.thePlayer.inventoryContainer.slotClick((slotIn == null) ? slotId : ((CreativeSlot)slotIn).slot.slotNumber, clickedButton, clickType, (EntityPlayer)Minecraft.thePlayer);
            ...
            this.inventorySlots.slotClick((slotIn == null) ? slotId : slotIn.slotNumber, clickedButton, clickType, (EntityPlayer)Minecraft.thePlayer);
    ...
    private void updateCreativeSearch() {
        ...
        for (i = (arrayOfEnchantment = Enchantment.enchantmentsBookList).length, b = 0; b < i; ) {
        ...
        while (iterator.hasNext()) {
            ...
            boolean flag = false;
            for (String s : itemstack.getTooltip((EntityPlayer)Minecraft.thePlayer, this.mc.gameSettings.advancedItemTooltips)) {
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
        if (mouseButton == 0) {
            ...
            for (k = (arrayOfCreativeTabs = CreativeTabs.creativeTabArray).length, b = 0; b < k; ) {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        int m;
        CreativeTabs[] arrayOfCreativeTabs;
        for (m = (arrayOfCreativeTabs = CreativeTabs.creativeTabArray).length, b = 0; b < m; ) {
            CreativeTabs creativetabs = arrayOfCreativeTabs[b];
    ...
    protected void renderToolTip(ItemStack stack, int x, int y) {
        if (selectedTabIndex == CreativeTabs.tabAllSearch.getTabIndex()) {
            List<String> list = stack.getTooltip((EntityPlayer)Minecraft.thePlayer, this.mc.gameSettings.advancedItemTooltips);
            ...
            if (creativetabs == null && stack.getItem() == Items.enchanted_book) {
                ...
                if (map.size() == 1) {
                    ...
                    int j;
                    CreativeTabs[] arrayOfCreativeTabs;
                    for (j = (arrayOfCreativeTabs = CreativeTabs.creativeTabArray).length, b = 0; b < j; ) {
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        if (creativetabs == CreativeTabs.tabInventory)
            GuiInventory.drawEntityOnScreen(this.guiLeft + 43, this.guiTop + 45, 20, (this.guiLeft + 43 - mouseX), (this.guiTop + 45 - 30 - mouseY), (EntityLivingBase)Minecraft.thePlayer); 
    }
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        if (button.id == 0)
            this.mc.displayGuiScreen((GuiScreen)new GuiAchievements((GuiScreen)this, Minecraft.thePlayer.getStatFileWriter())); 
        if (button.id == 1)
            this.mc.displayGuiScreen((GuiScreen)new GuiStats((GuiScreen)this, Minecraft.thePlayer.getStatFileWriter())); 
    }
