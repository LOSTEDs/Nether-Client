...
public class GuiButton extends Gui {
    ...
    public void drawButton(Minecraft mc, int mouseX, int mouseY) {
        if (HudManager.buttonStyle.isEnabled()) {
            if (this.visible) {
                ...
                drawHorizontalLine(this.xPosition, this.xPosition + this.width, this.yPosition, 1146443093);
                drawHorizontalLine(this.xPosition, this.xPosition + this.width, this.yPosition + this.height, 1146443093);
                drawVerticalLine(this.xPosition, this.yPosition + this.height, this.yPosition, 1146443093);
                drawVerticalLine(this.xPosition + this.width, this.yPosition + this.height, this.yPosition, 1146443093);
