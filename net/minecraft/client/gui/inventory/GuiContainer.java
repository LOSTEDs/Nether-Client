...
public abstract class GuiContainer extends GuiScreen {
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
        ...
        if (mouseButton == 0 || mouseButton == 1 || flag) {
            ...
            if (flag1)
                l = -999; 
            if (this.mc.gameSettings.touchscreen && flag1 && Minecraft.thePlayer.inventory.getItemStack() == null) {
            ...
            if (isShiftKeyDown()) {
                if (slot != null && slot.inventory != null && this.shiftClickedSlot != null)
                    for (Slot slot2 : this.inventorySlots.inventorySlots) {
                        if (slot2 != null && slot2.canTakeStack((EntityPlayer)Minecraft.thePlayer) && slot2.getHasStack() && slot2.inventory == slot.inventory && Container.canAddItemToSlot(slot2, this.shiftClickedSlot, true))
    ...
    protected void handleMouseClick(Slot slotIn, int slotId, int clickedButton, int clickType) {
        ...
        this.mc.playerController.windowClick(this.inventorySlots.windowId, slotId, clickedButton, clickType, (EntityPlayer)Minecraft.thePlayer);
    }
    ...
    public void onGuiClosed() {
        if (Minecraft.thePlayer != null)
            this.inventorySlots.onContainerClosed((EntityPlayer)Minecraft.thePlayer); 
    }
