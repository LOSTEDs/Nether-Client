...
public class CommandParticle extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException {
        ...
        for (j = (arrayOfEnumParticleTypes = EnumParticleTypes.values()).length, b = 0; b < j; ) {
            EnumParticleTypes enumparticletypes1 = arrayOfEnumParticleTypes[b];
        ...
        if (world instanceof WorldServer) {
            ...
            if (enumparticletypes.hasArguments()) {
                ...
                for (int k = 1; k < astring.length; k++) {
                    try {
                        aint[k - 1] = Integer.parseInt(astring[k]);
