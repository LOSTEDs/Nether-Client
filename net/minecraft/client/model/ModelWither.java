...
public class ModelWither extends ModelBase {
    ...
    public void render(Entity entityIn, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_, float p_78088_6_, float scale) {
        ...
        for (i = (arrayOfModelRenderer = this.field_82904_b).length, b = 0; b < i; ) {
            ModelRenderer modelrenderer = arrayOfModelRenderer[b];
            modelrenderer.render(scale);
            b++;
        } 
        for (i = (arrayOfModelRenderer = this.field_82905_a).length, b = 0; b < i; ) {
            ModelRenderer modelrenderer1 = arrayOfModelRenderer[b];
