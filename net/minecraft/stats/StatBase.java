...
public class StatBase {
    ...
    public static IStatType timeStatType = new IStatType() {
            public String format(int p_75843_1_) {
                ...
                double d3 = d2 / 24.0D;
                double d4 = d3 / 365.0D;
                return (d4 > 0.5D) ? (String.valueOf(StatBase.decimalFormat.format(d4)) + " y") : ((d3 > 0.5D) ? (String.valueOf(StatBase.decimalFormat.format(d3)) + " d") : ((d2 > 0.5D) ? (String.valueOf(StatBase.decimalFormat.format(d2)) + " h") : ((d1 > 0.5D) ? (String.valueOf(StatBase.decimalFormat.format(d1)) + " m") : (String.valueOf(d0) + " s"))));
            }
        };
    ...
    public static IStatType distanceStatType = new IStatType() {
            public String format(int p_75843_1_) {
                ...
                return (d1 > 0.5D) ? (String.valueOf(StatBase.decimalFormat.format(d1)) + " km") : ((d0 > 0.5D) ? (String.valueOf(StatBase.decimalFormat.format(d0)) + " m") : (String.valueOf(p_75843_1_) + " cm"));
            }
        };
