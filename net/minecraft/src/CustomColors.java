...
public class CustomColors {
    ...
    public static void update() {
        ...
        if (Config.isCustomColors()) {
            ...
            xpOrbColors = getCustomColors(String.valueOf(s) + "xporb.png", -1, -1);
            durabilityColors = getCustomColors(String.valueOf(s) + "durability.png", -1, -1);
            String[] astring10 = { "stem.png", "stemcolor.png" };
            stemColors = getCustomColors(s, astring10, 8, 1);
            stemPumpkinColors = getCustomColors(String.valueOf(s) + "pumpkinstem.png", 8, 1);
            stemMelonColors = getCustomColors(String.valueOf(s) + "melonstem.png", 8, 1);
            ...
            blockColormaps = readBlockColormaps(new String[] { String.valueOf(s) + "custom/", String.valueOf(s) + "blocks/" }, colorsBlockColormaps, 256, 256);
            updateUseDefaultGrassFoliageColors();
        } 
    }
    ...
    private static Pair<LightMapPack[], Integer> parseLightMapPacks() {
        ...
        for (int l1 = 0; l1 < acustomcolormap.length; l1++) {
            ...
            if (customcolormap3 != null) {
                ...
                CustomColormap customcolormap1 = getCustomColors(String.valueOf(s6) + "/" + s5 + "_rain.png", -1, -1);
                CustomColormap customcolormap2 = getCustomColors(String.valueOf(s6) + "/" + s5 + "_thunder.png", -1, -1);
