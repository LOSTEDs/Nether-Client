...
public class GuiNewChat extends Gui {
                    ...
                    if (chatline != null) {
                        ...
                        if (j1 < 200 || flag) {
                            ...
                            if (l1 > 3) {
                                int i2 = 0;
                                int j2 = -i1 * 9;
                                if (!HudManager.clearChat.isEnabled())
    ...
    public void printChatMessage(IChatComponent chatComponent) {
        if (HudManager.compactChat.isEnabled()) {
    ...
    public void printChatMessageWithOptionalDeletion(IChatComponent p_146234_1_, int p_146234_2_) {
        ...
        if (HudManager.autoGGMod.isEnabled() && 
            Minecraft.getMinecraft().getCurrentServerData() != null && (Minecraft.getMinecraft().getCurrentServerData()).serverIP.contains("hypixel") && (p_146234_1_.getUnformattedText().contains("WINNER!") || p_146234_1_.getUnformattedText().contains("1st Killer -") || p_146234_1_.getUnformattedText().contains("Top Survivors"))) {
            System.out.println("AutoGG");
            Minecraft.getMinecraft();
            Minecraft.thePlayer.sendChatMessage("/achat gg");
        } 
