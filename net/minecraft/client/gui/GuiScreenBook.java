...
public class GuiScreenBook extends GuiScreen {
    ...
    private void pageInsertIntoCurrent(String p_146459_1_) {
        ...
        int i = this.fontRendererObj.splitStringWidth(String.valueOf(s1) + EnumChatFormatting.BLACK + "_", 118);
        ...
        if (this.bookGettingSigned) {
            ...
            if (this.bookIsUnsigned) {
                if (this.fontRendererObj.getBidiFlag()) {
                    ...
                    s5 = String.valueOf(s5) + EnumChatFormatting.BLACK + "_";
                } else {
                    s5 = String.valueOf(s5) + EnumChatFormatting.GRAY + "_";
                } 
