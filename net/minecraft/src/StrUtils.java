...
public class StrUtils {
    public static boolean equalsMask(String p_equalsMask_0_, String p_equalsMask_1_, char p_equalsMask_2_, char p_equalsMask_3_) {
        if (p_equalsMask_1_ != null && p_equalsMask_0_ != null) {
            ...
            char c = p_equalsMask_2_;
            if (p_equalsMask_1_.startsWith(c))
                list.add(""); 
            StringTokenizer stringtokenizer = new StringTokenizer(p_equalsMask_1_, c);
            while (stringtokenizer.hasMoreElements())
                list.add(stringtokenizer.nextToken()); 
            if (p_equalsMask_1_.endsWith(c))
                list.add(""); 
    ...
    public static String stringInc(String p_stringInc_0_) {
        ...
        if (i == -1)
            return ""; 
        int j = ++i;
        return (j.length() > p_stringInc_0_.length()) ? "" : fillLeft(i, p_stringInc_0_.length(), '0');
    }
    ...
    public static String addSuffixCheck(String p_addSuffixCheck_0_, String p_addSuffixCheck_1_) {
        return (p_addSuffixCheck_0_ != null && p_addSuffixCheck_1_ != null) ? (p_addSuffixCheck_0_.endsWith(p_addSuffixCheck_1_) ? p_addSuffixCheck_0_ : (String.valueOf(p_addSuffixCheck_0_) + p_addSuffixCheck_1_)) : p_addSuffixCheck_0_;
    }
    
    public static String addPrefixCheck(String p_addPrefixCheck_0_, String p_addPrefixCheck_1_) {
        return (p_addPrefixCheck_0_ != null && p_addPrefixCheck_1_ != null) ? (p_addPrefixCheck_0_.endsWith(p_addPrefixCheck_1_) ? p_addPrefixCheck_0_ : (String.valueOf(p_addPrefixCheck_1_) + p_addPrefixCheck_0_)) : p_addPrefixCheck_0_;
    }
}
