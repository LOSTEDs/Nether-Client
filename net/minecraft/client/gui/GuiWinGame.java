...
public class GuiWinGame extends GuiScreen {
    ...
    private void sendRespawnPacket() {
        Minecraft.thePlayer.sendQueue.addToSendQueue((Packet)new C16PacketClientStatus(C16PacketClientStatus.EnumState.PERFORM_RESPAWN));
        ...
        if (this.field_146582_i == null) {
            ...
            try {
                ...
                while ((s = bufferedreader.readLine()) != null) {
                    for (s = s.replaceAll("PLAYERNAME", this.mc.getSession().getUsername()); s.contains(s1); s = String.valueOf(s2) + EnumChatFormatting.WHITE + EnumChatFormatting.OBFUSCATED + "XXXXXXXX".substring(0, random.nextInt(4) + 3) + s3) {
                        int j = s.indexOf(s1);
